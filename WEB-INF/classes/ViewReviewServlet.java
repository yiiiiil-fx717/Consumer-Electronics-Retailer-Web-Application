...
public class ViewReviewServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Content shown in main area
		out.println("    <div id=\"body\">");
		out.println("		<section id=\"content\">");
		
		//out.println("<div id=\"table\">");
        out.println("   <table class=\"reviewtable\" border=\"1\">");
        out.println("       <caption>Product Review</caption>");
        out.println("           <tr>");
        out.println("               <td>Username</td>");
        out.println("               <td>xwx</td>");
        out.println("           </tr>");
        out.println("           <tr>");
        out.println("               <td>Review Rate</td>");
        out.println("               <td>5</td>");
        out.println("           </tr>");
        out.println("           <tr>");
        out.println("               <td>Review Date</td>");
        out.println("               <td>20171021</td>");
        out.println("           </tr>");
        out.println("           <tr>");
        out.println("               <td>Review Text</td>");
        out.println("               <td>Very good</td>");
        out.println("           </tr>");
        out.println("   </table>");
        //out.println("</div>");
