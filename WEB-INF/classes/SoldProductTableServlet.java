...
public class SoldProductTableServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for(int i: hsmp.keySet()){
            ...
            out.println("<tr>");
            out.println("   <td>" + pr.getItemName() + "</td>");
            out.println("   <td>" + pr.getItemPrice() + "</td>");
            out.println("   <td>" + pr.getSoldNum() + "</td>");
            out.println("</tr>");
        }
