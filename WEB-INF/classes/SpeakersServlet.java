...
public class SpeakersServlet extends HttpServlet {
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    out.println("</header>");
 	...
 	out.println("<li class=\"start selected\"><a href=\"SpeakersServlet\">Speakers</a></li>");
...
/*
	out.println("<div>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image38.png\" alt=\"Beats Pill+ Portable Speaker\"/></a>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image39.png\" alt=\"AmazonBasics\" /></a>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image40.png\" alt=\"Anker SoundCore\" /></a>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image41.png\" alt=\"OontZ Angle 3\" /></a>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image42.png\" alt=\"DOSS Touch\" /></a>");
	out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image43.png\" alt=\"Cyber Acoustics\" /></a>");
    out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image44.png\" alt=\"ZOEE S1\" /></a>");
    out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image45.png\" alt=\"Aud Mini by iLuv\" /></a>");
    out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image46.png\" alt=\"Edifier R1280T\" /></a>");
    out.println("<a href=\"SpeakersServlet\"><img class=\"content-image\" src=\"images/image47.png\" alt=\"JBL Flip 3\" /></a>");
	out.println("</div>");
*/
