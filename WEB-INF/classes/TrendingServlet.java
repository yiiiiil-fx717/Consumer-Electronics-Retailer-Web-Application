...
public class TrendingServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("				<h3>Top-5 Zip-Code Where Max Number of Product Sold</h3>");
		out.println("				<p>60616<br>60949<br>61851<br>43070<br>45389</p>");
		out.println("			</article>");

		out.println("			<article class=\"expanded\">");
		out.println("				<h3>Top-5 Most Sold Product</h3>");
		out.println("				<p>iPhone SE<br>Macbook<br>Airpods<br>BeatsX<br>Samsung Galaxy S8</p>");
		out.println("			</article>");

        out.println("           <article>");
        out.println("               <h3>Top-5 Most Liked Product</h3>");
        out.println("               <p>iPhone7<br>Macbook Pro<br>Apple Watch Edition<br>Seagate Expansion 1TB<br>iPhone SE</p>");
        out.println("           </article>");
		out.println("        </section>");
