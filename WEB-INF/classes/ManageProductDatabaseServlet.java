 ...
 */
public class ManageProductDatabaseServlet extends HttpServlet {
    //private static final long serialVersionUID = 1L;
    private XmlSaveToHashmap xMLHashmapProduct = new XmlSaveToHashmap("C:\\apache-tomcat-7.0.34\\webapps\\HW1\\WEB-INF\\classes\\Product.xml");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, java.io.IOException {
        ...
        */
        ...
        if(productrebate != null && productrebate.length() != 0){
            productrebate = productrebate.trim();
        }
        ...
        if(type.equalsIgnoreCase("Add")){
            if(productid != null && productimage != null && productname != null && 
                ...
                */
                ...
                MySQLDataStoreUtilities.addProduct(Integer.parseInt(productid), productimage, productname, productcolor, Integer.parseInt(productprice), Integer.parseInt(productstock), productrebate, productaccessory1, productaccessory2, productaccessory3, productaccessory4, productaccessory5, productaccessory6, productaccessory7);
            ...
            if(productid != null){
                ...
                */
                MySQLDataStoreUtilities.deleteProduct(Integer.parseInt(productid));
                response.sendRedirect("/HW1/ManagerFunctionServlet");
            }else{
