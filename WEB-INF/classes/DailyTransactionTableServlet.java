...
public class DailyTransactionTableServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<caption>Sold Product</caption>");
        out.println("   <tr>");
        ...
        HashMap<Integer, DailySales> hsmp = new HashMap<Integer, DailySales>();
        Statement st = null;
        ResultSet rs = null;
        DailySales p;
        try{
            ...
            rs = st.executeQuery("select creditnum,date,sum(sales) as totalsale from orderinfo group by date;");
            while(rs.next()){
                String creditcard = rs.getString("creditnum");
                String date   = rs.getString("date");
                int sales     = rs.getInt("totalsale");
                p = new DailySales(creditcard, date, sales);
                hsmp.put(Integer.parseInt(creditcard),p);
            }
        }catch(Exception e){
            e.printStackTrace();
        }
        ...
        for(int i: hsmp.keySet()){
            DailySales pr = hsmp.get(i);
            out.println("<tr>");
            out.println("   <td>" + pr.getDate() + "</td>");
            out.println("   <td>" + pr.getSales() + "</td>");
            out.println("</tr>");
        }
    ...
    //end of content table
		...
		//left navigation bar        
		{
            ...
            out.println("                    <li><a href=\"DailyTransactionTableServlet\">Daily Transaction</a></li>");
            out.println("                </ul>");
            out.println("            </li>");
