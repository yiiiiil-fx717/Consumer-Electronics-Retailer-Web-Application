...
public class ProductDetailServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Item item = productHashmap.getItem(id);
        ...
        for (String accessory: item.accessories) {
            if(null == accessory.trim()) continue;
            out.println("		accessory: " + accessory);
        	out.println("		<br />");
        }

        //for(int i = 1; i <= 10; i++){
            Item item1 = productHashmap.getItem(id);
            //if(null == item1) continue;
            out.println("        <div class=\"product\">");
            out.println("            <ul>");
            out.println("                <li><b>" + item1.name + "</b></li>");
            out.println("                <li><b>$ " + item1.price + "</b></li>");
            out.println("                <li><a href=\"ProductDetailServlet?id=" + id + "\"><img class=\"content-image\" src=\"images/" + item1.image + ".png\" alt=" + item1.name + "/></a></li>");
            out.println("                <li><a href=\"CartServlet?id=" + id + "\" class=\"button \">Buy Now</a></li>");
